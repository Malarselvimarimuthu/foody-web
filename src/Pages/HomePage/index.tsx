...
import { BiFontSize } from 'react-icons/bi';
    ...
    <div>
      ...
      >
        ...
        <div className="card-body">
          ...
          >
            <b><h1 style={{fontSize:80,fontFamily:'open sans'}}><b>Foodie Go</b></h1></b>
          </h5>
          <p
            className="card-text"
            style={{
          ...
          >
            Discover best foods & drinks
          </p>
          <nav className="navbar navbar-light navbar-custom">
            <Form className="form-inline mx-auto" style={{ width: '20%' }}>
              <Button
                style={{ backgroundColor: '#fff', color: 'black' }}
                type="button"
                onClick={handleSearchClick}
              >
                <h5><FaSearch style={{width:40 ,height:15}} />
                Search here...</h5>
              </Button>
            </Form>
          </nav>
  ...
  <Row>
    <Col xs={12} md={6} className="d-flex justify-content-center mb-4">
      ...
      >
        <Card className="hover-card" style={{ width: '600px', maxWidth: '600px' }}>
          <Card.Img
            variant="top"
  ...
  <Carousel interval={1000}>
    <Carousel.Item>
      <div className="d-flex justify-content-center">
        <Card className="w-100" style={{ maxWidth: '80rem', height: '30rem' }}>
          <Card.Img
            variant="top"
...
<Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              <Form.Label><br></br>Email address</Form.Label>
              <Form.Control
                type="email"
      ...
      <MDBFooter className="bg-light text-center text-white">
        ...
        <div className="text-center p-3" style={{ backgroundColor: '#454340' }}>
          © 2024 Copyright:
          <a className="text-white" href="https://FoodieGo.com/">
            FoodieGo.com
          </a>
        </div>
      </MDBFooter>
